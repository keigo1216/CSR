...
if __name__ == "__main__":
    ...
    parser.add_argument("--B",         type=int, default=32,             help="辞書の縦（または横）の画素数. 黒木様の資料は全画素数でやっていますので注意. ")
    parser.add_argument("--K",         type=int, default=1,              help="学習枚数")
    parser.add_argument("--Rho",       type=int, default=1,              help="ADMMの係数ロー")
    parser.add_argument("--Lam",       type=int, default=0.0001,          help="最適化する時のハイパーパラメータ")
    parser.add_argument("--data_dir",  type=str, default= "../dataset",  help="データセットのディレクトリ")
    parser.add_argument("--coef_loop", type=int, default=5,              help="係数マップの最適化回数")
    parser.add_argument("--dict_loop", type=int, default=5,              help="辞書の最適化回数")
    parser.add_argument("--hole_loop", type=int, default=100,           help="全体の最適化回数")
